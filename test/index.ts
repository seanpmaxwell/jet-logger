...
const logger1 = new JetLogger(LoggerModes.Custom, 'jet-logger-alt2.log', true, 
  true, undefined, sendLog);
...
/* Alternate File Name */
const logger2 = new JetLogger(LoggerModes.File, 'jet-logger-alt.log', false, 
  false);
